...
const databaseDirectory = path_1.default.join(process.cwd(), 'database');
if (!fs_1.default.existsSync(databaseDirectory)) {
    fs_1.default.mkdirSync(databaseDirectory, { recursive: true });
}
const databaseFilePath = path_1.default.join(databaseDirectory, 'transcendence.sqlite');
const databaseConnection = new sqlite3_1.default.Database(databaseFilePath, (err) => {
    if (err) {
