...
class App {
    ...
    handlePopState(event) {
        ...
        const path = ((_a = event.state) === null || _a === void 0 ? void 0 : _a.path) || (window.location.pathname === '/index.html' ? '/' : window.location.pathname);
        this.renderView(path);
    }
    checkAuth() {
        ...
        this.webSocket.onclose = () => {
            ...
            if (!this.intentionalDisconnect) {
                ...
                setTimeout(() => this.checkAuth().then(isAuth => {
                    if (isAuth && !this.intentionalDisconnect)
    ...
    renderView(path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.isAuthenticated = yield this.checkAuth();
            ...
            const createBackButton = (text, path) => {
            ...
            `;
                ...
                if (username) {
                    yield renderProfilePage(this.pageContentElement, username);
                }
                else {
            ...
            `;
                ...
                this.currentViewCleanup = yield renderTournamentView(this.pageContentElement);
            }
            else if (path === '/settings') {
                yield renderSettingsPage(this.pageContentElement);
            }
            else if (path === '/friends') {
                yield renderSocialView(this.pageContentElement);
            }
    ...
    handleGoogleCallback() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield fetch('/api/auth/google/callback', {
                    method: 'POST',
    ...
    renderTwoFactorView() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            form.addEventListener('submit', (e) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const res = yield fetch('/api/auth/google/verify-2fa', {
                        method: 'POST',
