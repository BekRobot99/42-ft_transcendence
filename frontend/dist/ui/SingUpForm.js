...
export class SignUpForm {
    constructor(app) {
        ...
        this.checkIconPath = `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>`;
        this.crossIconPath = `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>`;
        this.app = app;
    ...
    updateValidation(id, isValid) {
        const iconSvgElement = document.getElementById(`${id}-check`);
        if (iconSvgElement) {
            if (isValid) {
