...
export function renderGamePage3D(container, tournamentOptions) {
    ...
    `;
    const canvas = document.getElementById('pongCanvas3D');
    if (!canvas) {
    ...
    // Keyboard state
    const keysPressed = {};
    const keyDownHandler = (e) => { keysPressed[e.key] = true; };
    const keyUpHandler = (e) => { keysPressed[e.key] = false; };
...
//# sourceMappingURL=GamePage3D.js.map