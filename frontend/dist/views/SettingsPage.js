...
export function renderSettingsPage(container) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let user;
        try {
            const res = yield fetch('/api/me', { credentials: 'include' });
            if (!res.ok)
    ...
    `;
        ...
        avatarFileInput.addEventListener('change', () => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            reader.onload = (e) => { var _a; avatarPreview.src = (_a = e.target) === null || _a === void 0 ? void 0 : _a.result; };
            reader.readAsDataURL(file);
            const formData = new FormData();
            formData.append('avatar', file);
            try {
                const res = yield fetch('/api/me/avatar', {
                    method: 'POST',
                    credentials: 'include',
                    body: formData,
                });
        ...
        deleteAvatarBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
    ...
    `;
        ...
        twofaButton.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            twofaContainer.innerHTML = '';
            if (!user.twofa_enabled) {
                // Enable flow: get QR code
                const res = yield fetch('/api/2fa/setup', { method: 'POST', credentials: 'include' });
                const data = yield res.json();
                if (!res.ok) {
            ...
            `;
                ...
                verifyBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                    msg.textContent = '';
                    ...
                    const res2 = yield fetch('/api/2fa/enable', {
                        method: 'POST',
                        credentials: 'include',
            ...
            `;
                const msg = document.createElement('p');
                msg.className = 'text-sm mt-2';
                disableBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                    msg.textContent = '';
                    ...
                    const res2 = yield fetch('/api/2fa/disable', {
                        method: 'POST',
                        credentials: 'include',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ code }),
